            ...
            <div key={datum.id} className="bg-white shadow-md mx-5 my-5 rounded-lg lg:w-1/5 md:w-1/4 sm:w-1/3 w-full">
                <div className="px-4 py-4 text-green-500">
                    ...
                    <div className="flex mt-3 items-center justify justify-between">
                        <div className="flex">
                            <svg name="love" onClick={() =>{ toast.success("Added to favorites!"); }} className={`cursor-pointer h-6 w-6 focus:outline-none love-btn hover:text-pink-500`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
